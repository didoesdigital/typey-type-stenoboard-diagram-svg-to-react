...
if ARGV.size < 2
  $stderr.puts "Usage: ruby ./no-number-bar-outer-thumb-numbers-prepare-optimized-svg-for-react-component.rb STENO_LAYOUT.svg STENOLAYOUTStenoDiagram.jsx"
  exit 1
end
...
KEYS = ["leftNumberBarKey", "rightNumberBarKey", "leftSUpperKey", "leftSLowerKey", "leftTKey", "leftKKey", "leftPKey", "leftWKey", "leftHKey", "leftRKey", "leftAKey", "leftOKey", "leftStarUpperKey", "leftStarLowerKey", "rightStarUpperKey", "rightStarLowerKey", "rightEKey", "rightUKey", "rightFKey", "rightRKey", "rightPKey", "rightBKey", "rightLKey", "rightGKey", "rightTKey", "rightSKey", "rightDKey", "rightZKey"]

SYMBOLS = ["leftNumberBar", "rightNumberBar", "leftSUpper", "leftSLower", "leftT", "leftK", "leftP", "leftW", "leftH", "leftR", "leftA", "leftO", "leftStarUpper", "leftStarLower", "rightStarUpper", "rightStarLower", "rightE", "rightU", "rightF", "rightR", "rightP", "rightB", "rightL", "rightG", "rightT", "rightS", "rightD", "rightZ"]
