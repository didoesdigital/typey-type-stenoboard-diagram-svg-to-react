    ...
    return (
      <svg id={svgDiagramID} width="140" fill="none" viewBox="0 0 232 108" xmlns="http://www.w3.org/2000/svg" aria-hidden={true}>
        <g id={"stenoboard-" + this.props.brief }>
          ...
          <rect height="19" id="leftSUpperKey" width="17" fill={this.props.leftSUpperKey ? leftSUpperKeyOnColor : leftSUpperKeyOffColor} rx="3.5" stroke={leftSUpperKeyStrokeColor} x="0.5" y="19.5"/>
          <rect height="19" id="leftSLowerKey" width="17" fill={this.props.leftSLowerKey ? leftSLowerKeyOnColor : leftSLowerKeyOffColor} rx="3.5" stroke={leftSLowerKeyStrokeColor} x="0.5" y="43.5"/>
          ...
          <path id="leftNumberBar" d="M45.552 84l.464-3.04h-1.84l.224-1.408h1.824l.384-2.544h-1.776l.208-1.392h1.776l.432-2.816h1.456l-.432 2.816h2.112l.432-2.816h1.456l-.432 2.816h1.84l-.208 1.392h-1.84l-.4 2.544h1.792L52.8 80.96h-1.776L50.56 84h-1.456l.464-3.04h-2.096L47.008 84h-1.456zm2.128-4.448h2.096l.4-2.544h-2.112l-.384 2.544z" fill={this.props.leftNumberBar ? leftNumberBarOnColor : leftNumberBarOffColor}/>
          <path id="rightNumberBar" d="M158.552 84l.464-3.04h-1.84l.224-1.408h1.824l.384-2.544h-1.776l.208-1.392h1.776l.432-2.816h1.456l-.432 2.816h2.112l.432-2.816h1.456l-.432 2.816h1.84l-.208 1.392h-1.84l-.4 2.544h1.792l-.224 1.408h-1.776L163.56 84h-1.456l.464-3.04h-2.096l-.464 3.04h-1.456zm2.128-4.448h2.096l.4-2.544h-2.112l-.384 2.544z" fill={this.props.rightNumberBar ? rightNumberBarOnColor : rightNumberBarOffColor}/>
          ...
          <path id="leftA" d="M71.616 84l-.8-2.608h-3.76L66.272 84h-1.76l3.664-11.2h1.488L73.36 84h-1.744zm-4.096-4.096h2.832l-1.136-3.712a10.99 10.99 0 01-.288-1.168c-.075.395-.17.784-.288 1.168l-1.12 3.712z" fill={this.props.leftA ? leftAOnColor : leftAOffColor}/>
          ...
          <path id="rightE" d="M118.376 84V72.8h6.864v1.552h-5.216v3.088h3.472v1.552h-3.472v3.44h5.568V84h-7.216z" fill={this.props.rightE ? rightEOnColor : rightEOffColor}/>
          <path id="rightU" d="M141.928 84.192c-1.12 0-2.016-.352-2.688-1.056-.672-.715-1.008-1.845-1.008-3.392V72.8h1.648v6.944c0 1.93.683 2.896 2.048 2.896 1.376 0 2.064-.965 2.064-2.896V72.8h1.632v6.944c0 1.536-.336 2.661-1.008 3.376-.661.715-1.557 1.072-2.688 1.072z" fill={this.props.rightU ? rightUOnColor : rightUOffColor}/>
          <path id="rightF" d="M139.376 34V22.8h7.296v1.552h-5.648v3.088h4.032v1.552h-4.032V34h-1.648z" fill={this.props.rightF ? rightFOnColor : rightFOffColor}/>
          ...
          <path id="rightB" d="M159.376 58V46.8h3.504c1.237 0 2.133.283 2.688.848.555.565.832 1.27.832 2.112 0 1.11-.517 1.888-1.552 2.336.608.192 1.083.528 1.424 1.008.352.47.528 1.024.528 1.664 0 .896-.299 1.659-.896 2.288-.587.63-1.515.944-2.784.944h-3.744zm1.648-6.56h1.584c.715 0 1.253-.139 1.616-.416.373-.288.56-.683.56-1.184 0-1.024-.613-1.536-1.84-1.536h-1.92v3.136zm0 5.04h2.24c.693 0 1.184-.16 1.472-.48.299-.32.448-.715.448-1.184 0-1.248-.8-1.872-2.4-1.872h-1.76v3.536z" fill={this.props.rightB ? rightBOnColor : rightBOffColor}/>
          <path id="rightL" d="M179.376 34V22.8h1.648v9.616h5.248V34h-6.896z" fill={this.props.rightL ? rightLOnColor : rightLOffColor}/>
          ...
          <path id="rightT" d="M202.112 34v-9.632h-3.248V22.8h8.128v1.568h-3.248V34h-1.632z" fill={this.props.rightT ? rightTOnColor : rightTOffColor}/>
          ...
          <path id="rightZ" d="M226.64 46.8v1.232l-5.296 8.416h5.264V58h-7.376v-1.216l5.264-8.432H219.6V46.8h7.04z" fill={this.props.rightZ ? rightZOnColor : rightZOffColor}/>
        </g>
      </svg>
    );
  }
