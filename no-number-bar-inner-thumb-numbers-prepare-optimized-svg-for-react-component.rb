...
KEYS = ["numberBarKey", "leftSUpperKey", "leftSLowerKey", "leftTKey", "leftKKey", "leftPKey", "leftWKey", "leftHKey", "leftRKey", "leftAKey", "leftOKey", "starUpperKey", "starLowerKey", "rightEKey", "rightUKey", "rightFKey", "rightRKey", "rightPKey", "rightBKey", "rightLKey", "rightGKey", "rightTKey", "rightSKey", "rightDKey", "rightZKey"]

SYMBOLS = ["numberBar", "leftSUpper", "leftSLower", "leftT", "leftK", "leftP", "leftW", "leftH", "leftR", "leftA", "leftO", "starUpper", "starLower", "rightE", "rightU", "rightF", "rightR", "rightP", "rightB", "rightL", "rightG", "rightT", "rightS", "rightD", "rightZ"]
